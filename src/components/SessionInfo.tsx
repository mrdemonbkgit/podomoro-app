...
export const SessionInfo = ({ sessionType, completedSessions, sessionsUntilLongBreak, isDark }: SessionInfoProps) => {
  return (
    <div className="text-center mb-12 mt-4 lg:mt-0">
      {/* Question */}
      <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-8 flex items-center justify-center gap-4 flex-wrap">
