...
export const SessionInfo = ({ sessionType, completedSessions, sessionsUntilLongBreak, isDark, onEditTasks, currentTask }: SessionInfoProps) => {
  return (
    <div className="text-center mb-6 md:mb-8">
      ...
      <div className="mb-6">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3 flex items-center justify-center gap-3 flex-wrap">
          ...
          >
            <svg className="w-6 h-6 md:w-8 md:h-8 text-white/60 hover:text-white/90 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
            </svg>
          </button>
        </h2>
        {currentTask && (
          <p className="text-sm text-white/50 font-light italic">Working on your priority</p>
        )}
      </div>
